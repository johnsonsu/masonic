...
function Masonry(props) {
  ...
  const containerPos = (0, _useContainerPosition.useContainerPosition)(
    containerRef,
    windowSize
  );
  ...
  nextProps.resizeObserver = (0, _useResizeObserver.useResizeObserver)(
    nextProps.positioner
  );
  const scrollToIndex = (0, _useScrollToIndex.useScrollToIndex)(
    nextProps.positioner,
    {
