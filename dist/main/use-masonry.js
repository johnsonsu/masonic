...
var _memoizeOne = /*#__PURE__*/ _interopRequireDefault(
  /*#__PURE__*/ require("@essentials/memoize-one")
);

var _oneKeyMap = /*#__PURE__*/ _interopRequireDefault(
  /*#__PURE__*/ require("@essentials/one-key-map")
);

var _latest = /*#__PURE__*/ _interopRequireDefault(
  /*#__PURE__*/ require("@react-hook/latest")
);
...
const createRenderElement = /*#__PURE__*/ (0, _trieMemoize.default)(
  [_oneKeyMap.default, {}, WeakMap, _oneKeyMap.default],
...
const getContainerStyle = /*#__PURE__*/ (0, _memoizeOne.default)(
...
const assignUserStyle = /*#__PURE__*/ (0, _memoizeOne.default)(
  (containerStyle, userStyle) => Object.assign({}, containerStyle, userStyle), // @ts-expect-error
  cmp2
);
...
const getCachedSize = /*#__PURE__*/ (0, _memoizeOne.default)(
  (width) => ({
    width,
    zIndex: -1000,
    visibility: "hidden",
...
const getRefSetter = /*#__PURE__*/ (0, _memoizeOne.default)(
